package com.example.perscholas.glab30955.model;
...
public class RequestParamController {
    ...
    @ResponseBody
    public String handler(@RequestParam Map<String, String> param){
    ...
    @ResponseBody
    public String handler(@RequestParam("firstName") String firstName, @RequestParam(name = "middleName", required =
            false) String middleName, @RequestParam("lastName") String lastName) {
